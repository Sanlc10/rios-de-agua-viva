...
function TestimonialCard({
    ...
    return (
        <a
            ...
            className={cn(
                "relative flex h-auto min-h-[140px] sm:min-h-[180px] w-[260px] sm:w-[380px] -skew-y-[8deg] select-none flex-col rounded-2xl border border-white/10 bg-white/10 backdrop-blur-md px-3 sm:px-4 py-3 sm:py-4 transition-all duration-500 hover:border-white/20 hover:bg-white/15 cursor-pointer shadow-xl",
        ...
        >
            ...
            <div className="flex items-start gap-2 sm:gap-3 mb-2 sm:mb-3">
                <div className="size-9 sm:size-12 rounded-full bg-gradient-to-br from-green-400 via-yellow-400 to-green-500 flex items-center justify-center overflow-hidden shrink-0 shadow-lg border border-white/10">
                    {avatar ? (
                ...
                <TwitterIcon className="size-4 sm:size-5 text-white/80 shrink-0" />
            </div>

            {/* Content */}
            <p className="text-white/90 text-xs sm:text-[15px] leading-relaxed mb-2 sm:mb-3 line-clamp-3 sm:line-clamp-4 font-fira">
                {content}
            </p>
